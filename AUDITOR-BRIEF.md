...
- The rewards owner can propose arbitrary Merkle roots. The contract enforces proof membership and solvency, not fair allocation or holder eligibility. A timelock only helps if somebody reviews and can act. Exclusions, weighting and thresholds remain off-chain policy.
...
4. Pending/active reservations, partial payments, early close/cancel reconciliation, duplicate recipients, forged roots and cross-round replay.
