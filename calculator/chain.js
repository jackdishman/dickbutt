...
export const DISTRIBUTOR_ABI=['event Paid(uint256 indexed roundId,address indexed account,uint256 amount)','function nextRoundId() view returns(uint256)','function availableForNextRound() view returns(uint256)','function minPayout() view returns(uint256)','function rewardToken() view returns(address)','function roundInfo(uint256) view returns(bytes32,uint256,uint256,bool,bool)','function pending(uint256) view returns(bytes32,uint256,uint256)'];
